...
def badges():
    while True:
        ...
        if option in ['1', 'Hypersquad Bravery', 'House of Bravery', 'Bravery']:
            house_of_bravery = requests.post('https://discord.com/api/v6/hypesquad/online', json = {'house_id': '1'}, headers = {'authorization': token})
            ...
            house_of_brilliance = requests.post('https://discord.com/api/v6/hypesquad/online', json = {'house_id': '2'}, headers = {'authorization': token})
            ...
            house_of_balance = requests.post('https://discord.com/api/v6/hypesquad/online', json = {'house_id': '3'}, headers = {'authorization': token})
